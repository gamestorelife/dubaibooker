     ...
     <label id="phone-label" for="phone">
        <strong>Selected Details</strong>
         ...
         <div class="d-flex justify-content-between">
            <div><strong> <p>Check In date</p></strong> </div>
           <div> <p>${bookingData.checkInDate} <i class="fa-light fa-calendar-day"></i></p> </div>
         </div>


          <div class="d-flex justify-content-between">
            <div><strong> <p>Check Out date</p> </strong></div>
           <div> <p>${bookingData.checkOutDate}  <i class="fa-light fa-calendar-day"></i></p> </div>
         </div>


        <div class="d-flex justify-content-between">
            <div> <strong><p>Adults</p> </strong></div>
            <div>  <p> ${bookingData.adults}  <i class="fa-duotone fa-thin fa-user"></i></p> </div>
        </div>
